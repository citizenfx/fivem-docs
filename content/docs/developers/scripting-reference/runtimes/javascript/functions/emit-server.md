...
You need to declare the event on the server with [on](/docs/developers/scripting-reference/runtimes/javascript/functions/on-server) or [onNet](/docs/developers/scripting-reference/runtimes/javascript/functions/onNet-server) first.
