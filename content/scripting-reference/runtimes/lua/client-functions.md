...
- [RemoveEventHandler](/scripting-reference/runtimes/lua/functions/RemoveEventHandler)
- [SendNUIMessage](/scripting-reference/runtimes/lua/functions/SendNUIMessage)
- [TriggerEvent](/scripting-reference/runtimes/lua/functions/TriggerEvent)
- [TriggerServerEvent](/scripting-reference/runtimes/lua/functions/TriggerServerEvent)
- [vec](/scripting-reference/runtimes/lua/functions/vec)
